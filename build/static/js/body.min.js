! function(e, t) {
	...
	function T(e, t) {
		if (1 === t.nodeType && re.hasData(e)) {
			...
			if (s) {
				...
				for (n in s)
					for (i = 0, r = s[n].length; i < r; i++) re.event.add(t, n, s[n][i])
			}
	...
	function k(e) {
		var t = he,
			n = Ze[e];
		return n || (n = N(e, t), "none" !== n && n || (Ke = (Ke || re("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = (Ke[0].contentWindow || Ke[0].contentDocument).document, t.write(), t.close(), n = N(e, t), Ke.detach()), Ze[e] = n), n
	}
	...
	function j(e, t) {
		for (var n, i, r, o = [], a = 0, s = e.length; a < s; a++) i = e[a], i.style && (o[a] = re._data(i, "olddisplay"), n = i.style.display, t ? (o[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && je(i) && (o[a] = re._data(i, "olddisplay", k(i.nodeName)))) : (r = je(i), (n && "none" !== n || !r) && re._data(i, "olddisplay", r ? n : re.css(i, "display"))));
	...
	function A(e, t, n, i, r) {
		for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2) "margin" === n && (a += re.css(e, n + Se[o], !0, r)), i ? ("content" === n && (a -= re.css(e, "padding" + Se[o], !0, r)), "margin" !== n && (a -= re.css(e, "border" + Se[o] + "Width", !0, r))) : (a += re.css(e, "padding" + Se[o], !0, r), "padding" !== n && (a += re.css(e, "border" + Se[o] + "Width", !0, r)));
		return a
	}
	...
	function D(e, t, n) {
		...
		if (r <= 0 || null == r) {
			if (r = tt(e, t, o), (r < 0 || null == r) && (r = e.style[t]), it.test(r)) return r;
	...
	function F(e, t, n) {
		...
		})), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], u = re.css(e, "display"), c = "none" === u ? re._data(e, "olddisplay") || k(e.nodeName) : u, "inline" === c && "none" === re.css(e, "float") && (ne.inlineBlockNeedsLayout && "inline" !== k(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")), n.overflow && (p.overflow = "hidden", ne.shrinkWrapBlocks() || f.always(function() {
		...
		if (re.isEmptyObject(d)) "inline" === ("none" === u ? k(e.nodeName) : u) && (p.display = u);
		else {
			m ? "hidden" in m && (h = m.hidden) : m = re._data(e, "fxshow", {}), o && (m.hidden = !h), h ? re(e).show() : f.done(function() {
				re(e).hide()
			}), f.done(function() {
				var t;
			...
			for (i in d) a = M(h ? m[i] : 0, i, f), i in m || (m[i] = a.start, h && (a.end = a.start, a.start = "width" === i || "height" === i ? 1 : 0))
		}
	}
	...
	function I(e, t, n, i) {
		...
		if (re.isArray(t)) re.each(t, function(t, r) {
			n || Ut.test(e) ? i(e, r) : I(e + "[" + ("object" == typeof r ? t : "") + "]", r, n, i)
		});
	...
	re.fn = re.prototype = {
		...
		proxy: function(e, t) {
			var n, i, r;
			if ("string" == typeof t && (r = e[t], t = e, e = r), re.isFunction(e)) return n = Y.call(arguments, 2), i = function() {
	...
	var ue = function(e) {
		function t(e, t, n, i) {
			...
			if ((t ? t.ownerDocument || t : R) !== H && D(t), t = t || H, n = n || [], !e || "string" != typeof e) return n;
			...
			if (_ && !i) {
				...
				if (w.qsa && (!M || !M.test(e))) {
					if (p = f = P, h = t, m = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
						for (u = k(e), (f = t.getAttribute("id")) ? p = f.replace(be, "\\$&") : t.setAttribute("id", p), p = "[id='" + p + "'] ", l = u.length; l--;) u[l] = p + d(u[l]);
		...
		function p(e, t, n) {
			...
			return t.first ? function(t, n, o) {
				...
				if (a) {
					...
					for (; t = t[i];)
						if (1 === t.nodeType || r) {
							if (l = t[P] || (t[P] = {}), (s = l[i]) && s[0] === W && s[1] === o) return u[2] = s[2];
		...
		function v(e, t, n, r, o, a) {
			return r && !r[P] && (r = v(r)), o && !o[P] && (o = v(o, a)), i(function(i, a, s, l) {
				var u, c, f, d = [],
					...
					x = n ? o || (i ? e : h || r) ? [] : a : y;
				if (n && n(y, x, s, l), r)
					for (u = g(x, p), r(u, [], s, l), c = u.length; c--;)(f = u[c]) && (x[p[c]] = !(y[p[c]] = f));
				if (i) {
					if (o || e) {
						if (o) {
						...
						for (c = x.length; c--;)(f = x[c]) && (u = o ? te.call(i, f) : d[c]) > -1 && (i[u] = !(a[u] = f))
					}
				} else x = g(x === a ? x.splice(h, x.length) : x), o ? o(null, a, x, l) : Z.apply(a, x)
			})
		}
				...
				if (n = T.relative[e[s].type]) c = [p(h(c), n)];
					...
					if (n = T.filter[e[s].type].apply(null, e[s].matches), n[P]) {
						...
						return v(s > 1 && h(c), s > 1 && d(e.slice(0, s - 1).concat({
							value: " " === e[s - 2].type ? "*" : ""
						})).replace(le, "$1"), n, s < i && y(e.slice(s, i)), i < r && y(e = e.slice(i)), i < r && d(e))
					}
					c.push(n)
				}
			return h(c)
			...
			var r = n.length > 0,
				...
				a = function(i, a, s, l, u) {
					var c, f, d, p = 0,
						...
						w = x.length;
					for (u && (j = a !== H && a); h !== w && null != (c = x[h]); h++) {
						if (o && c) {
							for (f = 0; d = e[f++];)
								if (d(c, a, s)) {
									l.push(c);
		...
		var b, w, T, C, N, k, E, S, j, L, A, D, H, q, _, M, F, O, B, P = "sizzle" + -new Date,
			R = e.document,
			W = 0,
			$ = 0,
			z = n(),
		...
		w = t.support = {}, N = t.isXML = function(e) {
			...
			var t, n = e ? e.ownerDocument || e : R,
				i = n.defaultView;
			return n !== H && 9 === n.nodeType && n.documentElement ? (H = n, q = n.documentElement, _ = !N(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function() {
				D()
			...
			}, F = [], M = [], (w.qsa = ve.test(n.querySelectorAll)) && (r(function(e) {
			...
			})), (w.matchesSelector = ve.test(O = q.matches || q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector)) && r(function(e) {
				w.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), F.push("!=", se)
				...
				return i ? i : (i = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & i || !w.sortDetached && t.compareDocumentPosition(e) === i ? e === n || e.ownerDocument === R && B(R, e) ? -1 : t === n || t.ownerDocument === R && B(R, t) ? 1 : L ? te.call(L, e) - te.call(L, t) : 0 : 4 & i ? -1 : 1)
			} : function(e, t) {
				if (e === t) return A = !0, 0;
				var i, r = 0,
					o = e.parentNode,
					...
					l = [e],
					u = [t];
				if (!o || !s) return e === n ? -1 : t === n ? 1 : o ? -1 : s ? 1 : L ? te.call(L, e) - te.call(L, t) : 0;
				if (o === s) return a(e, t);
			...
			if ((e.ownerDocument || e) !== H && D(e), n = n.replace(fe, "='$1']"), w.matchesSelector && _ && (!F || !F.test(n)) && (!M || !M.test(n))) try {
				var i = O.call(e, n);
			...
			var n = T.attrHandle[t.toLowerCase()],
				i = n && Y.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !_) : void 0;
				...
				CHILD: function(e, t, n, i, r) {
					...
					return 1 === i && 0 === r ? function(e) {
						...
						if (g) {
							...
							} else if (y && (u = (t[P] || (t[P] = {}))[e]) && u[0] === W) d = u[1];
							else
								for (;
									(f = ++p && f && f[m] || (d = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++d || (y && ((f[P] || (f[P] = {}))[e] = [W, d]), f !== t)););
		...
		return f.prototype = T.filters = T.pseudos, T.setFilters = new f, k = t.tokenize = function(e, n) {
			...
			var n, i = [],
				...
				o = X[e + " "];
			if (!o) {
				for (t || (t = k(e)), n = t.length; n--;) o = y(t[n]), o[P] ? i.push(o) : r.push(o);
			...
			return (u || E(e, f))(i, t, !_, n, xe.test(e) && c(t.parentNode) || t), n
		}, w.sortStable = P.split("").sort(U).join("") === P, w.detectDuplicates = !!A, D(), w.sortDetached = r(function(e) {
	...
	var pe, he = e.document,
		...
		ge = re.fn.init = function(e, t) {
			...
			if ("string" == typeof e) {
				...
				if (n[1]) {
					if (t = t instanceof re ? t[0] : t, re.merge(this, re.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : he, !0)), fe.test(n[1]) && re.isPlainObject(t))
	...
	re.extend({
		...
		closest: function(e, t) {
			for (var n, i = 0, r = this.length, o = [], a = ce.test(e) || "string" != typeof e ? re(e, t || this.context) : 0; i < r; i++)
	...
	re.Callbacks = function(e) {
			...
			f = {
				...
				remove: function() {
					return l && re.each(arguments, function(e, n) {
						for (var i;
							(i = re.inArray(n, l, i)) > -1;) l.splice(i, 1), t && (i <= r && r--, i <= a && a--)
					}), this
				},
				has: function(e) {
		...
		when: function(e) {
			...
			if (a > 1)
				for (t = new Array(a), n = new Array(a), i = new Array(a); r < a; r++) o[r] && re.isFunction(o[r].promise) ? o[r].promise().done(u(r, i, o)).fail(l.reject).progress(u(r, n, t)) : --s;
	...
	var Ee = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
		...
		Le = re.access = function(e, t, n, i, r, o, a) {
			var s = 0,
				l = e.length,
				u = null == n;
			if ("object" === re.type(n)) {
	...
	re.event = {
		...
		add: function(e, t, n, i, r) {
			...
			if (g) {
				for (n.handler && (l = n, n = l.handler, r = l.selector), n.guid || (n.guid = re.guid++), (a = g.events) || (a = g.events = {}), (c = g.handle) || (c = g.handle = function(e) {
					...
					}, c.elem = e), t = (t || "").match(xe) || [""], s = t.length; s--;) o = Me.exec(t[s]) || [], p = m = o[1], h = (o[2] || "").split(".").sort(), p && (u = re.event.special[p] || {}, p = (r ? u.delegateType : u.bindType) || p, u = re.event.special[p] || {}, f = re.extend({
					type: p,
					origType: m,
					data: i,
					handler: n,
					...
					namespace: h.join(".")
				}, l), (d = a[p]) || (d = a[p] = [], d.delegateCount = 0, u.setup && u.setup.call(e, i, h, c) !== !1 || (e.addEventListener ? e.addEventListener(p, c, !1) : e.attachEvent && e.attachEvent("on" + p, c))), u.add && (u.add.call(e, f), f.handler.guid || (f.handler.guid = n.guid)), r ? d.splice(d.delegateCount++, 0, f) : d.push(f), re.event.global[p] = !0);
				e = null
			}
		},
			...
			if (g && (c = g.events)) {
				for (t = (t || "").match(xe) || [""], u = t.length; u--;)
					if (s = Me.exec(t[u]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
						for (f = re.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, d = c[p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = o = d.length; o--;) a = d[o], !r && m !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || i && i !== a.selector && ("**" !== i || !a.selector) || (d.splice(o, 1), a.selector && d.delegateCount--, f.remove && f.remove.call(e, a));
						l && !d.length && (f.teardown && f.teardown.call(e, h, g.handle) !== !1 || re.removeEvent(e, p, g.handle), delete c[p])
					} else
		...
		trigger: function(t, n, i, r) {
			...
			if (s = c = i = i || he, 3 !== i.nodeType && 8 !== i.nodeType && !_e.test(p + re.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."), p = h.shift(), h.sort()), a = p.indexOf(":") < 0 && "on" + p, t = t[re.expando] ? t : new re.Event(p, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : re.makeArray(n, [t]), u = re.event.special[p] || {}, r || !u.trigger || u.trigger.apply(i, n) !== !1)) {
				...
				for (f = 0;
					(s = d[f++]) && !t.isPropagationStopped();) t.type = f > 1 ? l : u.bindType || p, o = (re._data(s, "events") || {})[t.type] && re._data(s, "handle"), o && o.apply(s, n), o = a && s[a], o && o.apply && re.acceptData(s) && (t.result = o.apply(s, n), t.result === !1 && t.preventDefault());
				if (t.type = p, !r && !t.isDefaultPrevented() && (!u._default || u._default.apply(d.pop(), n) === !1) && re.acceptData(i) && a && i[p] && !re.isWindow(i)) {
			...
			if (s && l.nodeType && (!e.button || "click" !== e.type))
				for (; l != this; l = l.parentNode || this)
					if (1 === l.nodeType && (l.disabled !== !0 || "click" !== e.type)) {
						for (r = [], o = 0; o < s; o++) i = t[o], n = i.selector + " ", void 0 === r[n] && (r[n] = i.needsContext ? re(n, this).index(l) >= 0 : re.find(n, this, null, [l]).length), r[n] && r.push(i);
						r.length && a.push({
							elem: l,
							handlers: r
						})
		...
		fix: function(e) {
			...
			var t, n, i, r = e.type,
				o = e,
				a = this.fixHooks[r];
			for (a || (this.fixHooks[r] = a = qe.test(r) ? this.mouseHooks : He.test(r) ? this.keyHooks : {}), i = a.props ? this.props.concat(a.props) : this.props, e = new re.Event(o), t = i.length; t--;) n = i[t], e[n] = o[n];
	...
	Ye.optgroup = Ye.option, Ye.tbody = Ye.tfoot = Ye.colgroup = Ye.caption = Ye.thead, Ye.th = Ye.td, re.extend({
		...
		buildFragment: function(e, t, n, i) {
			for (var r, o, a, s, l, u, c, f = e.length, d = m(t), p = [], h = 0; h < f; h++)
				...
				for (s = s || d.appendChild(t.createElement("div")), l = (We.exec(o) || ["", ""])[1].toLowerCase(), c = Ye[l] || Ye._default, s.innerHTML = c[1] + o.replace(Re, "<$1></$2>") + c[2], r = c[0]; r--;) s = s.lastChild;
				if (!ne.leadingWhitespace && Pe.test(o) && p.push(t.createTextNode(Pe.exec(o)[0])), !ne.tbody)
					for (o = "table" !== l || $e.test(o) ? "<table>" !== c[1] || $e.test(o) ? 0 : s : s.firstChild, r = o && o.childNodes.length; r--;) re.nodeName(u = o.childNodes[r], "tbody") && !u.childNodes.length && o.removeChild(u);
				for (re.merge(p, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
				s = d.lastChild
			} else p.push(t.createTextNode(o));
			for (s && d.removeChild(s), ne.appendChecked || re.grep(g(p, "input"), v), h = 0; o = p[h++];)
				if ((!i || re.inArray(o, i) === -1) && (a = re.contains(o.ownerDocument, o), s = g(d.appendChild(o), "script"), a && w(s), n))
		...
		cleanData: function(e, t) {
			for (var n, i, r, o, a = 0, s = re.expando, l = re.cache, u = ne.deleteExpando, c = re.event.special; null != (n = e[a]); a++)
				if ((t || re.acceptData(n)) && (r = n[s], o = r && l[r])) {
					...
					l[r] && (delete l[r], u ? delete n[s] : typeof n.removeAttribute !== Ce ? n.removeAttribute(s) : n[s] = null, J.push(r))
				}
		}
	}), re.fn.extend({
		text: function(e) {
		...
		domManip: function(e, t) {
			...
			if (u && (s = re.buildFragment(e, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
				for (o = re.map(g(s, "script"), x), r = o.length; l < u; l++) i = s, l !== f && (i = re.clone(i, !0, !0), r && re.merge(o, g(i, "script"))), t.call(this[l], i, l);
				if (r)
					for (a = o[o.length - 1].ownerDocument, re.map(o, b), l = 0; l < r; l++) i = o[l], Ue.test(i.type || "") && !re._data(i, "globalEval") && re.contains(a, i) && (i.src ? re._evalUrl && re._evalUrl(i.src) : re.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Je, "")));
				s = n = null
			}
			return this
		}
		...
		re.fn[e] = function(e) {
			for (var n, i = 0, r = [], o = re(e), a = o.length - 1; i <= a; i++) n = i === a ? this : this.clone(!0), re(o[i])[t](n), G.apply(r, n.get());
	...
	re.extend({
		...
		css: function(e, t, n, i) {
			var r, o, a, s = re.camelCase(t);
			return t = re.cssProps[s] || (re.cssProps[s] = S(e.style, s)), a = re.cssHooks[t] || re.cssHooks[s], a && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = tt(e, t, i)), "normal" === o && t in ft && (o = ft[t]), "" === n || n ? (r = parseFloat(o), n === !0 || re.isNumeric(r) ? r || 0 : o) : o
		}
		...
		re.cssHooks[t] = {
			...
			set: function(e, n, i) {
				var r = i && et(e);
				return L(e, n, i ? A(e, t, i, ne.boxSizing && "border-box" === re.css(e, "boxSizing", !1, r), r) : 0)
			}
		}
		...
		css: function(e, t) {
			return Le(this, function(e, t, n) {
				var i, r, o = {},
					a = 0;
				if (re.isArray(t)) {
					for (i = et(e), r = t.length; a < r; a++) o[t[a]] = re.css(e, t[a], !1, i);
					return o
				}
	...
	re.fn.extend({
		val: function(e) {
			var t, n, i, r = this[0]; {
				...
				if (r) return t = re.valHooks[r.type] || re.valHooks[r.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(r, "value")) ? n : (n = r.value, "string" == typeof n ? n.replace(bt, "") : null == n ? "" : n)
			}
		}
	}), re.extend({
		valHooks: {
	...
	re.fn.extend({
		...
		removeAttr: function(e, t) {
			var n, i, r = 0,
				o = t && t.match(xe);
			if (o && 1 === e.nodeType)
				for (; n = o[r++];) i = re.propFix[n] || n, re.expr.match.bool.test(n) ? Et && kt || !Nt.test(n) ? e[i] = !1 : e[re.camelCase("default-" + n)] = e[i] = !1 : re.attr(e, n, ""), e.removeAttribute(kt ? n : i)
		},
		attrHooks: {
			type: {
				set: function(e, t) {
		...
		set: function(e, t, n) {
			return t === !1 ? re.removeAttr(e, n) : Et && kt || !Nt.test(n) ? e.setAttribute(!kt && re.propFix[n] || n, n) : e[re.camelCase("default-" + n)] = e[n] = !0, n
		}
	}, re.each(re.expr.match.bool.source.match(/\w+/g), function(e, t) {
		var n = Ct[t] || re.find.attr;
		Ct[t] = Et && kt || !Nt.test(t) ? function(e, t, i) {
			var r, o;
		...
		addClass: function(e) {
			...
			if (u)
				for (t = (e || "").match(xe) || []; s < l; s++)
					if (n = this[s], i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(Lt, " ") : " ")) {
	...
	qt = Wt.exec(_t.toLowerCase()) || [], re.extend({
		active: 0,
		lastModified: {},
		etag: {},
		ajaxSettings: {
		...
		ajax: function(e, t) {
			function n(e, t, n, i) {
				var r, c, v, y, b, T = t;
				2 !== x && (x = 2, s && clearTimeout(s), u = void 0, a = i || "", w.readyState = e > 0 ? 4 : 0, r = e >= 200 && e < 300 || 304 === e, n && (y = $(f, w, n)), y = z(f, y, w, r), r ? (f.ifModified && (b = w.getResponseHeader("Last-Modified"), b && (re.lastModified[o] = b), b = w.getResponseHeader("etag"), b && (re.etag[o] = b)), 204 === e || "HEAD" === f.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = y.state, c = y.data, v = y.error, r = !v)) : (v = T, !e && T || (T = "error", e < 0 && (e = 0))), w.status = e, w.statusText = (t || T) + "", r ? h.resolveWith(d, [c, T, w]) : h.rejectWith(d, [w, T, v]), w.statusCode(g), g = void 0, l && p.trigger(r ? "ajaxSuccess" : "ajaxError", [w, f, r ? c : v]), m.fireWith(d, [w, T]), l && (p.trigger("ajaxComplete", [w, f]), --re.active || re.event.trigger("ajaxStop")))
			}
			"object" == typeof e && (t = e, e = void 0), t = t || {};
			var i, r, o, a, s, l, u, c, f = re.ajaxSetup({}, t),
				d = f.context || f,
			...
			if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || _t) + "").replace(Mt, "").replace(Rt, qt[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = re.trim(f.dataType || "*").toLowerCase().match(xe) || [""], null == f.crossDomain && (i = Wt.exec(f.url.toLowerCase()), f.crossDomain = !(!i || i[1] === qt[1] && i[2] === qt[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (qt[3] || ("http:" === qt[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = re.param(f.data, f.traditional)), R($t, f, t, w), 2 === x) return w;
			l = f.global, l && 0 === re.active++ && re.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Pt.test(f.type), o = f.url, f.hasContent || (f.data && (o = f.url += (Dt.test(o) ? "&" : "?") + f.data, delete f.data), f.cache === !1 && (f.url = Ft.test(o) ? o.replace(Ft, "$1_=" + At++) : o + (Dt.test(o) ? "&" : "?") + "_=" + At++)), f.ifModified && (re.lastModified[o] && w.setRequestHeader("If-Modified-Since", re.lastModified[o]), re.etag[o] && w.setRequestHeader("If-None-Match", re.etag[o])), (f.data && f.hasContent && f.contentType !== !1 || t.contentType) && w.setRequestHeader("Content-Type", f.contentType), w.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + It + "; q=0.01" : "") : f.accepts["*"]);
	...
	re.param = function(e, t) {
		...
		serializeArray: function() {
			return this.map(function() {
				...
				var e = this.type;
				return this.name && !re(this).is(":disabled") && Yt.test(this.nodeName) && !Jt.test(e) && (this.checked || !Ae.test(e))
			}).map(function(e, t) {
				var n = re(this).val();
	...
	re.ajaxSetup({
		...
		if (s || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = re.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(en, "$1" + r) : t.jsonp !== !1 && (t.url += (Dt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
	...
	re.offset = {
		setOffset: function(e, t, n) {
			var i, r, o, a, s, l, u, c = re.css(e, "position"),
				f = re(e),
				d = {};
			"static" === c && (e.style.position = "relative"), s = f.offset(), o = re.css(e, "top"), l = re.css(e, "left"), u = ("absolute" === c || "fixed" === c) && re.inArray("auto", [o, l]) > -1, u ? (i = f.position(), a = i.top, r = i.left) : (a = parseFloat(o) || 0, r = parseFloat(l) || 0), re.isFunction(t) && (t = t.call(e, n, s)), null != t.top && (d.top = t.top - s.top + a), null != t.left && (d.left = t.left - s.left + r), "using" in t ? t.using.call(e, d) : f.css(d)
		}
	}, re.fn.extend({
		offset: function(e) {
			...
			var t, n, i = {
				...
				r = this[0],
				o = r && r.ownerDocument;
			if (o) return t = o.documentElement, re.contains(t, r) ? (typeof r.getBoundingClientRect !== Ce && (i = r.getBoundingClientRect()), n = V(o), {
		...
		re.cssHooks[t] = E(ne.pixelPosition, function(e, n) {
			if (n) return n = tt(e, t), it.test(n) ? re(e).position()[t] + "px" : n
		})
	}), re.each({
		Height: "height",
		Width: "width"
...
function(e, t, n, i) {
	function r(t, n) {
		this.options = e.extend({}, o, n), this.element = t, this.init()
	}
	var o = {
		header: "js-header",
		jumbo: "js-jumbo",
	...
	r.prototype.init = function() {
		var i, r = e(this.element),
			o = e("." + this.options.navAnchor),
			a = e("." + this.options.navLink),
			s = e("." + this.options.header),
			l = e("." + this.options.jumbo),
			u = (r.height(), s.offset().top),
			c = [];
		for (e(t).scroll(e.proxy(function() {
				var n = e(t).scrollTop();
				n > u ? (s.addClass(this.options.fixedHeader), l.addClass(this.options.jumboScroll)) : (s.removeClass(this.options.fixedHeader), l.removeClass(this.options.jumboScroll))
		...
		e(t).scroll(e.proxy(function() {
			...
			for (i = 0; i < c.length; i += 1) {
				var d = c[i],
					p = e(d).offset().top - u,
					h = e(d).height();
				o >= p && o < p + h ? a.filter("[href='" + d + "']").addClass(this.options.activeLink) : a.filter("[href='" + d + "']").removeClass(this.options.activeLink)
			}
			o + s === l && (r.find("li").filter(":last-child").find(a).hasClass(this.options.activeLink) || (a.filter("." + this.options.activeLink).removeClass(this.options.activeLink), r.find("li").filter(":last-child").find(a).addClass(this.options.activeLink))), o < f.offset().top && (r.find("li").filter(":first-child").find(a).hasClass(this.options.activeLink) || (a.filter("." + this.options.activeLink).removeClass(this.options.activeLink), r.find("li").filter(":first-child").find(a).addClass(this.options.activeLink)))
		}, this))
	}, e.fn.navKit = function(e) {
		return this.each(function() {
			new r(this, e)
		})
	}
	...
	function(e, t, n, i) {
		...
		r.prototype.init = function() {
			var t = e(this.element),
				n = t.find("." + this.options.item),
				i = (e("." + this.options.itemHidden), t.find("." + this.options.filterLink));
			e("." + this.options.filterSelected);
			i.on("click", function() {
				if (!e(this).hasClass("is-selected")) {
					i.removeClass("is-selected"), e(this).addClass("is-selected");
					var t = e(this).data("filter").toLowerCase();
					n.each(function() {
						e(this).data("cat").toLowerCase();
						e(this).is("[data-cat*=" + t + "]") ? e(this).removeClass("is-hidden") : e(this).addClass("is-hidden")
					})
				}
				return !1
			})
		}, e.fn.mixFilter = function(e) {
			return this.each(function() {
				new r(this, e)
			})
		}
